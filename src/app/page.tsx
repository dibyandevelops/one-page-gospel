...
import { Sparkles, BookMarked, ShieldCheck } from "lucide-react";
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gospel-canvas text-gospel-text">
      ...
      {/* Main Content Area */}
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-6 w-full pt-8 pb-16">
        {/* Hero Section */}
        <section className="text-center pt-8 pb-12 max-w-3xl mx-auto no-print">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-500 text-xs font-semibold uppercase tracking-wider mb-6 animate-fade-in-up">
            <Sparkles className="w-3.5 h-3.5" />
            Clear • Faithful • Life-Transforming
          </div>
          ...
          <p className="text-base sm:text-xl text-gospel-muted leading-relaxed font-serif max-w-2xl mx-auto mb-8 animate-fade-in-up">
